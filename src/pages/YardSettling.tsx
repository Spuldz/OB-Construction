...
export const YardSettling = () => {

    return(
        <>
            <Header/>
            <div className={styles.section1}>
                <TitleModal title="PAGALMU LABIEKĀRTOŠANA" body="Mēs sniedzam kvalitatīvus un augstas klases bruģēšanas pakalpojumus, lai jūsu īpašums izskatītos skaists un kopts, neatkarīgi no tā, vai tas ir privātais mājoklis vai komerciāls objekts."
                variant={{
                    interactive: false,
                    buttonText: ""
                }}/>
