    ...
    return(
        <>
            ...
            <div className={styles.section1}>
                <TitleModal title="KOKA MĒBELES" body="Mēs sniedzam kvalitatīvus un augstas klases bruģēšanas pakalpojumus, lai jūsu īpašums izskatītos skaists un kopts, neatkarīgi no tā, vai tas ir privātais mājoklis vai komerciāls objekts."
                variant={{
                    interactive: false,
                    buttonText: ""
                }}/>
